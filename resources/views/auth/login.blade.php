...
<!-- Mirrored from eliteadmin.themedesigner.in/demos/bt4/eliteadmin/pages-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 20 Apr 2023 17:00:27 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="skin-default card-no-border">
    ...
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">Abdullah admin</p>
        </div>
    </div>
    <!-- ============================================================== -->
                ...
                <div class="card-body">
                    <form class="form-horizontal form-material"  action="{{route('login')}}" method="POST">
                        ...
                        <div class="form-group ">
                            <div class="col-xs-12">
                                <input class="form-control" name="email" type="email" required="" placeholder="Email address"> </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-12">
