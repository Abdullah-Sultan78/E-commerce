                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12 col-12">
                            ...
                            <div class="xzoom-container">
                                <img class="xzoom3" src="{{asset($product->image)}}" xoriginal="{{asset($product->image)}}" />
                                <div class="xzoom-thumbs">
                                 @foreach ($product->otherImages as $otherImage)
                                  <a href="{{asset($otherImage->image)}}"><img class="xzoom-gallery3" width="80" src="{{asset($otherImage->image)}}"  xpreview="{{asset($otherImage->image)}}" title="The description goes here"></a>
                                  @endforeach
                                </div>
                              </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <p class="category"><i class="lni lni-tag">
                                </i> Category Name:<a href="javascript:void(0)">{{ $product->category->name }}</a>
                            </p>

                            <p class="category"><i class="lni lni-tag">
                                </i>SubCategory:<a href="javascript:void(0)">{{ $product->subCategory->name }}</a>
                            </p>

                            <p class="category"><i class="lni lni-tag">
                                </i>Product Brand:<a href="javascript:void(0)">{{ $product->brand->name }}</a>
                            </p>
