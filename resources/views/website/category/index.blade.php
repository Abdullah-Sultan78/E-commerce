                                        ...
                                        <div class="single-product">
                                            <div class="product-image">
                                                <img src="{{asset($product->image)}}"
                                                    alt="#">
                                                <div class="button">
                                                    <a href="{{route('product-details',['id'=> $product->id])}}" class="btn"><i
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12">
                                        ...
                                        <div class="single-product">
                                            <div class="row align-items-center">
                                                <div class="col-lg-4 col-md-4 col-12">
                                                    <div class="product-image">
                                                        <img src="{{ asset('/') }}website/assets/images/products/product-2.jpg"
                                                            alt="#">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12">
                                        ...
                                        <div class="single-product">
                                            <div class="row align-items-center">
                                                <div class="col-lg-4 col-md-4 col-12">
                                                    <div class="product-image">
                                                        <img src="{{ asset('/') }}website/assets/images/products/product-4.jpg"
                                                            alt="#">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12">
                                        ...
                                        <div class="single-product">
                                            <div class="row align-items-center">
                                                <div class="col-lg-4 col-md-4 col-12">
                                                    <div class="product-image">
                                                        <img src="{{ asset('/') }}website/assets/images/products/product-7.jpg"
                                                            alt="#">
